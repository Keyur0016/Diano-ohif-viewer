  ...
  return (
    ...
    >
      <div ref={drag}>
        <div
          className={classnames(
            'min-h-32 flex thumbnail-image-class flex-1 items-center justify-center overflow-hidden rounded-md bg-black text-base text-white',
            isActive
        ...
        >
          {imageSrc ? (
            <img
              src={imageSrc}
              alt={imageAltText}
              className="min-h-32 object-none thumbnail-image"
